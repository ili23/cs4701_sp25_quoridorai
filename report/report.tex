...
\begin{enumerate}
    \item \textbf{Random roll-outs.} Moves are played randomly until one player wins. The evaluation corresponds to the winning player. We quickly abandoned this method as rollouts required too much computation time and were mostly draws.
...
There are several features we create for our decision tree using this process. Each feature is calculated twice: once from each player's perspective.
