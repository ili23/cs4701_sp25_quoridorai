...
render(ax01, "(B) P1 resiliency graph", graph_path1, (1,), colorbar=ax_cbar)
render(ax10, "(C) P2 resiliency graph", graph_path2, (2,))
render(ax11, "(D) P1 liability graph", final_graph, (1, 2))
